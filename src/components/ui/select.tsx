  ...
  return (
    ...
    >
      <Headless.Select
        ...
        className={clsx([
          // Basic layout
          "relative block w-full appearance-none rounded-lg py-[calc(theme(spacing[2])-1px)] sm:py-[calc(theme(spacing[1])-1px)]",
          // Horizontal padding
          multiple
          ...
          // Typography
          "text-base/6 text-neutral-950 placeholder:text-neutral-500 dark:text-white dark:*:text-white sm:text-sm/6",
          // Border
          ...
          // Disabled state
          "data-[disabled]:border-neutral-950/20 data-[disabled]:opacity-100 dark:data-[hover]:data-[disabled]:border-white/15 data-[disabled]:dark:border-white/15 data-[disabled]:dark:bg-white/[2.5%]",
        ])}
      />
      {!multiple && (
        <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
          <svg
            className="size-5 stroke-neutral-500 group-has-[[data-disabled]]:stroke-neutral-600 dark:stroke-neutral-400 sm:size-4 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
