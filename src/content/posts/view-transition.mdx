...
<Note type="secondary" emoji="⚑">
  If you are using a browser that supports view transitions, you can experience an example by visiting my homepage and returning to this article.
</Note>
