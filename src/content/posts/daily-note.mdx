---
title: "Replicating Obsidian's Daily Notes Feature"
date: 2024-02-29
description: "Use Shortcuts and a text editor to replicate Obsidian's Daily Notes feature"
draft: false
---

import Note from "../../components/Note.astro";

I don't use Obsidian but I loved their Daily notes feature.
...
<Note type="secondary" emoji="⚠️">
  If you want the full year in the title you can write <code>yyyyMMdd</code>.
</Note>
