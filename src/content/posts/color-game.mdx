...
date: 2022-11-21
description: "Guess the shades of random HTML color codes."
draft: false
imageSrc: "../../assets/posts/noisy-gradient.jpg"
imageAlt: "A grainy gradient made of purple, pink, orange, and red."
---

import Note from "../../components/Note.astro";

{/* prettier-ignore */}
<Note type="device-alternate">Technologies used: CodeSandbox, React</Note>
